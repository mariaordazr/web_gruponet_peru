...
?>
<form class="form_productos" action="/admin/brands/create" method="post">
    <div class="input-group">
        <label class="label_title">Nombre</label>
        <input type="text" class="input_form" name="name" placeholder="Nombre de la marca">
        <input class="input_form btn" type="submit" value="Agregar Marca">
    </div>
</form>
